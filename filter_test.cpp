...
TEST(FilterFirstByteTest, BasicAssertions){
    std::vector<std::string> excepted_pool = {"1.231.69.33",
                                              "1.87.203.225",
                                              "1.70.44.170",
                                              "1.29.168.152",
                                              "1.1.234.8"};

    std::vector<std::string> input_pool = {"1.231.69.33",
                                           "22.134.11.1",
                                           "242.132.99.14",
                                           "1.87.203.225",
                                           "21.133.121.11",
                                           ...
                                           "24.132.99.145",
                                           "1.1.234.8"};
    std::sort(input_pool.begin(), input_pool.end(), IPUtils::compareIp);
...
TEST(FilterTwoByteTest, BasicAssertions){
    std::vector<std::string> excepted_pool = {"46.70.225.39",
                                              "46.70.147.26",
                                              "46.70.113.73",
                                              "46.70.29.76"};
...
TEST(FilterAnyByteTest, BasicAssertions){
    std::vector<std::string> excepted_pool = {"185.46.86.131",
                                              "185.46.85.204",
                                              "46.70.225.39",
                                              "46.70.147.26",
                                              "46.70.113.73",
